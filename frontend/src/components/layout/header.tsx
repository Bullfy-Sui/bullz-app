...
const Header = () => {
  ...
  return (
    <div className="flex fixed px-[1.5rem] py-[0.5rem] max-w-[26.875rem] mx-auto w-full z-50 top-0 items-center bg-background justify-between mt-[0.8125rem] mb-[1.62875rem]">
